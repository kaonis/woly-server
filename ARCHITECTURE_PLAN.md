...
1. Replace local protocol type duplicates with `@kaonis/woly-protocol`.
...
5. Publish `@kaonis/woly-protocol` to shared registry and migrate both repos from local `file:` dependency to pinned semver dependency.
