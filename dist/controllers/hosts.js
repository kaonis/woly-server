...
exports.getMacVendor = exports.addHost = exports.scanNetwork = exports.wakeUpHost = exports.getHost = exports.getAllHosts = void 0;
exports.setHostDatabase = setHostDatabase;
...
const wakeUpHost = async (req, res, next) => {
    const { name } = req.params;
    ...
    try {
        ...
        wake_on_lan_1.default.wake(host.mac, (error) => {
            if (error) {
 ...
 */
const getMacVendor = async (req, res, next) => {
    ...
    try {
        ...
        const response = await axios_1.default.get(`https://api.macvendors.com/${encodeURIComponent(mac)}`, {
            timeout: 5000,
            headers: {
...
exports.getMacVendor = getMacVendor;
