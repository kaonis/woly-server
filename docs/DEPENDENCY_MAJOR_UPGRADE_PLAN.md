...
| ESLint 10 watchdog automation | Merged                              | Added watchdog workflow with sticky issue updates via PR #160; current budget-mode configuration runs it manually       | #159     |
